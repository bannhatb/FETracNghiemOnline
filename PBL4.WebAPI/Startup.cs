...
using PBL4.WebAPI.Application.Behavior;
using PBL4.WebAPI.Application.Commands.Categories;
using PBL4.WebAPI.Application.Validations;
using PBL4.WebAPI.Infrastructure.Filters;
using PBL4.WebAPI.Infrastructure.Queries;
using PBL4.WebAPI.Services;
using PBL4.WebAPI.SignalR;
using System;
...
namespace PBL4.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Pbl4Context>(options =>
            {
